            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('register') }}">
                        ...
                        <div class="form-group row">
                            <label for="id_kantor" class="col-md-4 col-form-label text-md-right">{{ __('Kantor') }}</label>
                            <div class="col-md-6">
                        ...
                        <div class="form-group row">
                            <label for="id_unit" class="col-md-4 col-form-label text-md-right">{{ __('Unit') }}</label>
                            <div class="col-md-6">
                        ...
                        <div class="form-group row">
                            <label for="id_jabatan" class="col-md-4 col-form-label text-md-right">{{ __('Jabatan') }}</label>
                            <div class="col-md-6">
                        ...
                        <div class="form-group row">
                            <label for="id_divisi" class="col-md-4 col-form-label text-md-right">{{ __('Divisi') }}</label>
                            <div class="col-md-6">
                        ...
                        <div class="form-group row">
                            <label for="id_rank" class="col-md-4 col-form-label text-md-right">{{ __('Rank') }}</label>
                            <div class="col-md-6">
