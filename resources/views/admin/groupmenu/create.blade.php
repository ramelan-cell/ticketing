...
<div class="container">
    <div class="row justify-content-center">
        <div class="col-md-12">
            <div class="card">
                <div class="card-header">Tambah groupmenu</div>
                <div class="card-body">
                    <form class="form-horizontal" action="{{ route('groupmenu.store') }}" method="POST" enctype="multipart/form-data">
                        @csrf
                        <div class="panel-body">
                            <div class="form-group">
                                <label class="col-sm-2 control-label" for="groupmenu">{{__('groupmenu')}}</label>
                                <div class="col-sm-10">
                                    <input type="text" name="groupmenu" id="groupmenu" class="form-control"  required>
                                </div>
                            </div>
                            <div class="form-group">
