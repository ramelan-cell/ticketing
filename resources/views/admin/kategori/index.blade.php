...
<div class="container">
    <div class="row">
        <div class="col-md-4">
            <a href="{{ route('kategori.create')}}" class="btn btn-rounded btn-primary btn-sm"><span class="fa fa-plus"></span>&nbsp;{{__('Tambah')}}</a>
        </div>
        {{-- <div class="col-md-8">
    ...
    <div class="row justify-content-center">
        <div class="col-md-12">
            <div class="card">
                <div class="card-header" style="background-color: orange">Master kategori</div>
                <div class="card-body">
                            ...
                            <tbody>
                                @foreach($kategori as $key => $value)
                                    <tr>
                                        ...
                                        <td> <a href="{{route('kategori.edit', encrypt($value->id))}}" class="btn btn-success btn-sm"><span class="fa fa-edit"></span>&nbsp;{{('Edit')}}</a></td>
                                        <td>
